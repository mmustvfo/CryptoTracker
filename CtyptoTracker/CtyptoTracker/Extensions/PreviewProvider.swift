...
class DeveloperPreview {
    ...
    let stat = Statistic(title: "Market Cap", value: "$5.65Bn", percentageChange: 12)
    let stat2 = Statistic(title: "Market Cap", value: "$5.65Bn")
    let stat3 = Statistic(title: "Market Cap", value: "$5.65Bn", percentageChange: -12)
